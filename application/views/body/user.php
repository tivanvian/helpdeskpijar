		...
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url();?>user/user_list"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($datauser as $row) : $no++;?>
						     <tr>
						        ...
						        <td> 
<a title="Update User" class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>user/edit/<?php echo $row->id_user;?>"><span class="glyphicon glyphicon-edit" ></span></a>
<a data-toggle="modal"  title="Hapus User" class="hapus btn btn-danger btn-xs" href="#modKonfirmasi" data-id="<?php echo $row->id_user;?>"><span class="glyphicon glyphicon-trash"></span></a>
</td>
						    </tr>
						    <?php endforeach;?>
						    </tbody>
