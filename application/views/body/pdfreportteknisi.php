...
<div class="row" align="center">
  ...
  <?php $no = 0; foreach($datareportteknisi as $row) : $no++;?>
   <tr>
    ...
    <td>
  <div class="progress">
  <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" aria-valuenow="<?php echo $row->progress;?>" aria-valuemin="0" aria-valuemax="100" >
