...
<a href="<?php echo base_url();?>" style="text-decoration:none">Profile</a></div>
...
<a href="#" class="list-group-item"><span class="glyphicon glyphicon-th-large"></span> &nbsp;<?php echo $nrk;?></a>
...
<a href="#" class="list-group-item"><span class="glyphicon glyphicon-star"></span> &nbsp;<?php echo $jabatan;?></a>
