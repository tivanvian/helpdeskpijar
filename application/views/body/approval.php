						     ...
						     <tr>
						        ...
						        <td data-field="idS"><?php 
						        	...
						        	?></td>
						         	...
						         	{?>
						         	<td>
<a  title="Disetujui" class="ubah btn btn-success btn-xs" href="<?php echo base_url();?>approval/approval_yes/<?php echo $row->id_ticket;?>"><span class="glyphicon glyphicon-thumbs-up" ></span></a>
<a title="Ditolak" class="hapus btn btn-danger btn-xs" href="<?php echo base_url();?>approval/approval_no/<?php echo $row->id_ticket;?>"><span class="glyphicon glyphicon-thumbs-down"></span></a>
</td>
