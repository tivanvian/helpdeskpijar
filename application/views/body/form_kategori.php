...
<a href="#" style="text-decoration:none">Tambah Data Wilayah</a></div>
					...
					<div class="form-group">
						...
						<input class="form-control" name="nama_kategori" value="<?php echo $nama_kategori;?>" placeholder="Nama Wilayah" required>
					</div>
