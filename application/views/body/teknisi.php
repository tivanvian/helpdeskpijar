						...
						<table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="desc">
                           ...
                           <?php $no = 0; foreach($datateknisi as $row) : $no++;?>
						     <tr>
						        ...
						        <td> 
<a title="Update Teknisi" class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>teknisi/edit/<?php echo $row->id_teknisi;?>"><span class="glyphicon glyphicon-edit" ></span></a>
<a data-toggle="modal"  title="Hapus Teknisi" class="hapus btn btn-danger btn-xs" href="#modKonfirmasi" data-id="<?php echo $row->id_teknisi;?>"><span class="glyphicon glyphicon-trash"></span></a>
</td>
						    </tr>
						    <?php endforeach;?>
						    </tbody>
