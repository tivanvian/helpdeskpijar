<script language="javascript" type="text/javascript">
	...
	<br>
		...
		<div class="row">
            ...
            <a href="add" style="text-decoration:none">Ticket</a></div>
					...
					<input type="hidden" class="form-control" name="id_user" value="<?php echo $nrk;?>">
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						...
						<label>NRK</label>
						<input class="form-control" name="nama" placeholder="Nama" value="<?php echo $nrk;?>" disabled>
					    </div>
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						...
						<input class="form-control" name="problem_summary" placeholder="subjek masalah" value="<?php echo $problem_summary;?>" required>
					    </div>
					...
					<a href="<?php echo base_url();?>ticket/add"  class="btn btn-default">Batal</a>
				    </div>
