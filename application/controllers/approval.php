...
function __construct(){
 ...
 function approval_list()
 {
        ...
        $nrk = trim($this->session->userdata('nrk'));
        ...
        $sql_assignmentticket = "SELECT COUNT(id_ticket) AS jml_assignment_ticket FROM ticket WHERE status = 3 AND id_teknisi='$nrk'";
