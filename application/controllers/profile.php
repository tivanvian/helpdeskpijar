...
function view()
    {
       ...
       $id = $this->session->userdata('id_user');
        ...
        $sql = 
        "SELECT A.nik, A.nama,A.nrk , A.alamat, A.jk, B.level, B.level, C.nama_jabatan, D.nama_bagian_dept, E.nama_dept, C.nama_jabatan
        FROM karyawan A 
        ...
        LEFT JOIN departemen E ON E.id_dept = D.id_dept WHERE A.nrk ='$id'";
