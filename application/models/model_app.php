...
class Model_app extends CI_Model{
    ...
    {
    $query = $this->db->query('SELECT A.nama, A.nik, A.nrk, A.alamat, A.jk, C.nama_bagian_dept, B.nama_jabatan, D.nama_dept
    ...
    public function datalist_ticket()
    {
        ...
        $query = $this->db->query("SELECT D.nama, F.nama_dept, A.status, A.id_ticket, A.tanggal, B.nama_sub_kategori, C.nama_kategori
                                   ...
                                   LEFT JOIN karyawan D ON D.nrk = A.reported
    ...
    public function data_trackingticket($id)
    {
        ...
        $query = $this->db->query("SELECT A.tanggal, A.status, A.deskripsi, B.nama
                                   FROM tracking A
                                   LEFT JOIN karyawan B ON B.nrk = A.id_user
    ...
    public function datainformasi()
    {
        ...
        $query = $this->db->query("SELECT A.tanggal, A.subject, A.pesan, C.nama,C.nrk, A.id_informasi
                                   FROM informasi A
                                   LEFT JOIN karyawan C ON C.nrk =  A.id_user
                                   WHERE A.status = 1");
        return $query->result();
